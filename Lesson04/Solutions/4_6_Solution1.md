...
<title>Solution for practice 4.6.1</title>
</head>
...
**Explanatory and response variables**: Hours Studied is the explanatory variable (it's the variable we think influences the other) and Exam Score is the response variable. This means Hours Studied goes on the x-axis, and Exam Score goes on the y-axis.
