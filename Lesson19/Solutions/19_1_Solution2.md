...
Find the critical value. For a 95% confidence level, the remaining 5% is in the tails, with 2.5% in each tail. Using a Z-Table with a left tail area of 2.5%:

<img src="../images/Fig19_1b_Practice2_ZTable.png?raw=true" width="500" alt="95% Confidence Level on a Z-Table">
...
<img src="../images/Fig19_1b_Practice2_Desmos.png?raw=true" width="500" alt="95% Confidence Level Margin of Error on Desmos">
