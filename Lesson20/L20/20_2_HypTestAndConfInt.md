...
With 98% confidence, we see the true average battery life is between 17.892 and 19.508 hours. The null value ($$\mu_0 = 20$$) is *not* inside the confidence interval. So, we can __reject the null hypothesis__.
...
With 95% confidence, we see the true average score is between 76.185 and 80.215 points. The null value ($$\mu_0 = 75$$) is *not* inside the confidence interval. So, we can __reject the null hypothesis__.
