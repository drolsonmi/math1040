# Project 1: Design the Study
Here is the question your group will answer through the semester:
...
As a group, propose a study on how you will answer whether this is true or not following the instructions given above.
...
* [biology_experiment_dataset.csv](hhttps://snow0-my.sharepoint.com/:x:/g/personal/michael_olson2_snow_edu/EWtSg-Y9YRRKlf8Rtzs6zMgB8N8yfisATo9gMov_q4kdFw?e=q9g2fo)
...
* Plant Height After 4 Weeks (mean ≈ 15 cm, SD ≈ 3 cm)
* Leaf Color Intensity (scale from 1 to 10)
...
1. A biologist claims that the average plant height after 4 weeks of growth under varying sunlight conditions is at least 15 cm. At the 0.05 significance level, is there enough evidence to support the biologist’s claim?
2. In addition to the plant height, are the plants healthy? Using the leaf color intensity, determine if the majority are healthy using the benchmark you determined in project 6.
