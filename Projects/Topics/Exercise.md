...
* Weight Lost in 6 Weeks (mean ≈ 4.2 lbs, SD ≈ 1.5 lbs)
* Improvement in Energy Level (scale from 1 to 10)
...
1. A personal trainer claims that her new 6-week strength training program helps participants lose at least 5 pounds on average.
2. Does this program improve energy level? Determine if the majority of trainees report higher energy levels using the benchmark you determined in project 6.

At the 0.05 significance level, is there enough evidence to support the trainer's claim?
