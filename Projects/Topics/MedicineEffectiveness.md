...
* Side Effect Severity: Patient-reported, scale from 1 to 10
...
1. A pharmaceutical company claims that their new medication reduces symptom severity by at least 7 points on average after 2 weeks.
2. Do the patients report high side effects? Using the benchmark you determined in project 6, determine if the majority of patients report high side effects.

At the 0.05 significance level, is there enough evidence to support the company's claim?
