...
* Self-Reported Stamina Level (scale from 1 to 10)
...
1. A coach claims that the average sprint time for athletes in a training program is no more than 13 seconds.
2. Does this training program show high stamina? Determine if the majority of trainees report higher stamina using the benchmark you determined in project 6.

At the 0.05 significance level, is there enough evidence to support the coach's claim?
